...
def topics_and_schools
  ...
  nerd_culture.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("nerd_culture")).first_or_create
  end
  ...
  partying.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("partying")).first_or_create
  end
  ...
  academics.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("academics")).first_or_create
  end
  ...
  lgbt.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("lgbt")).first_or_create
  end
  ...
  career.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("career")).first_or_create
  end
  ...
  romance.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("romance")).first_or_create
  end
  ...
  fitness.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("fitness")).first_or_create
  end
  ...
  finance.each do |word|
    ReferenceWord.find_or_where(name: word.downcase, topic: Topic.find_by_name("finance")).first_or_create
  end
  ...
  housing.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("housing")).first_or_create
  end
  ...
  gender.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("gender")).first_or_create
  end
  ...
  politics.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("politics")).first_or_create
  end
  ...
  tech.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("tech")).first_or_create
  end
  ...
  food.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("food")).first_or_create
  end
  ...
  religion.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("religion")).first_or_create
  end
  ...
  art.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("art")).first_or_create
  end
  ...
  climate.each do |word|
    ReferenceWord.where(name: word.downcase, topic: Topic.find_by_name("climate")).first_or_create
  end
...
def log_to_new_posts(batch, new_posts)
  batch.each do |post|
    new_posts << post
  end
end
...
def original_post_seeding(new_posts)
  Dir['db/seeds/*'].each do |filename|
    ...
    log_to_new_posts(batch, new_posts)
